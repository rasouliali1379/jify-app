...
class CustomSpinner extends StatefulWidget {
  ...
  CustomSpinner({
    ...
    this.selectedItem = '',
    this.selectedItemTextStyle = const TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.normal),
    this.dropDownListTextStyle = const TextStyle(color: Colors.grey, fontSize: 15, backgroundColor: Colors.transparent),
    this.elevation: 5,
    this.padding: 8,
  ...
  @override
  _CustomSpinnerState createState() {
    return _CustomSpinnerState();
  }
}

class _CustomSpinnerState extends State<CustomSpinner> with WidgetsBindingObserver {
              ...
              Expanded(
                ...
                child: Padding(
                  ...
                  child: Text(
                    ...
                    textScaleFactor:
                        MediaQuery.of(context).textScaleFactor > 1.5 ? 1.5 : MediaQuery.of(context).textScaleFactor,
              ...
              Flexible(
                ...
                child: Align(
                  ...
                  child: Container(
                    ...
                    color: widget.dropDownIconBGColor,
  ...
  void findDropdownData() {
    final RenderBox renderBox = _gestureDetectorGlobalKey.currentContext!.findRenderObject() as RenderBox;
  ...
  OverlayEntry _createFloatingDropdown(int numOfListItemToShow) {
    final int numOfListItem =
        numOfListItemToShow != null && numOfListItemToShow <= 10 && numOfListItemToShow <= widget.dropDownList.length
            ? numOfListItemToShow
            : 4;
        ...
        child: Container(
          ...
          child: SafeArea(
            child: DropDownOverlay(
              ...
              dropDownList: (widget.dropDownList != null) ? widget.dropDownList : [],
              overlayBGColor:
                  (widget.dropDownOverlayBGColor != null) ? widget.dropDownOverlayBGColor : widget.dropDownBGColor,
              ...
              onOverlayOpen: (listItemHeight) {
                setState(() {
                  if (listItemHeight != null && listItemHeight as double > 0 && _listItemHeight != listItemHeight) {
...
class DropDownOverlay extends StatelessWidget {
  ...
  DropDownOverlay(
      ...
      this.dropDownListTextStyle:
          const TextStyle(color: Colors.grey, fontSize: 15, backgroundColor: Colors.transparent),
      required this.onOverlayOpen})
      : super(key: key);

  GlobalKey _listItemKey = GlobalKey();
  double getListItemHeight() {
    final RenderBox renderBox = _listItemKey.currentContext!.findRenderObject() as RenderBox;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        borderRadius: const BorderRadius.only(bottomLeft: Radius.circular(11.0), bottomRight: Radius.circular(11.0)),
      ...
      child: Container(
        decoration: BoxDecoration(
            borderRadius:
                const BorderRadius.only(bottomLeft: Radius.circular(11.0), bottomRight: Radius.circular(11.0)),
            color: Colors.white,
            boxShadow: [BoxShadow(offset: const Offset(0, 3), blurRadius: 5, color: AppColors.black.withOpacity(0.3))]),
